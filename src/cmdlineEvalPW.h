...
/** @brief Where the command line options are stored */
  struct gengetopt_args_info
  {
    ...
    const char *pw_help;
                       /**< @brief Password to evaluate help description.  */
    int verbose_flag;
                    /**< @brief Gain information about settings and results during run time (default=off).  */
    const char *verbose_help;
                            /**< @brief Gain information about settings and results during run time help description.  */
    int printWarnings_flag;
                          /**< @brief print warnings (default=off).  */
    const char *printWarnings_help;
                                  /**< @brief print warnings help description.  */
    ...
    const char *config_help;
                           /**< @brief Change the used config file help description.  */
